  ...
  return (
    <Navbar style={{ backgroundColor: '#0B0B0F', color: 'white', fontSize: 'bold'}} expand="lg" fixed="top" data-bs-theme="dark">
      ...
      <Navbar.Collapse style={{marginRight: 50, marginLeft: 50, padding: 10, }} id="basic-navbar-nav">
        ...
        <Nav style={{gap: 20,}}>
          <Button style={{color: 'white', borderColor: '#933FFE', }} variant="outline-primary" as={Link} to="/login">Entrar</Button>
          <Button style={{color: 'white', borderColor: '#933FFE', backgroundColor: '#933FFE' }} variant="primary" className="ml-2" as={Link} to="/register">Cadastre-se</Button>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
  );
