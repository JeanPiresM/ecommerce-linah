    ...
    <div style={{ marginTop: 100 }} className="login-container">
      <Container>
        <Row className="justify-content-center">
          <Col md={6}>
            <h2 style={{textAlign:"center", color: 'white', fontSize: 60, fontWeight: 'bold', marginTop: 100}} className="text-center mb-4">Bem-vindo de volta!</h2>
            ...
            <p style={{color: 'white'}} className="text-center mt-3">Ainda não tem uma conta? <a style={{color: '#898CA9'}} href="/register">Registre-se aqui</a></p>
          </Col>
        </Row>
      </Container>
    </div>
